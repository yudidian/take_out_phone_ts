<template>
	...
	<CellGroup inset class="cell-item">
		<Cell :title="sendInfo.payMethod === 1 ? '微信支付' : '支付宝支付'" is-link @click="showSheet = true" />
	</CellGroup>
	<CellGroup inset class="cell-item">
		<Cell title="购物车列表" />
	...
	<CellGroup inset>
		<Field v-model="sendInfo.remark" rows="2" autosize label="备注" type="textarea" maxlength="50" placeholder="请输入备注" show-word-limit />
	</CellGroup>
	<ActionSheet v-model:show="showSheet" :actions="actions" cancel-text="取消" close-on-click-action @select="selectHandler" />
</template>

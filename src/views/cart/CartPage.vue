<template>
	<div class="cart-content">
		...
		<CartList ref="cartList" @get-cart-length="getCartLength" @get-price="getPrice" />
		<SubmitBar :disabled="disabled" :price="price" button-text="去结算" @submit="$router.push('/settlement')" />
	</div>
</template>
